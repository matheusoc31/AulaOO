...
public class Trabalho {
    ...
    public static void main(String[] args) {
        ...
        int cont = 0;
        /**
         * Código responsável pelo jogo em sí. Nele o usuário deverá escolher um
         * dos 8 ginásio que podem ser desafiados. Ao escolher um ginásio
         * ocorrerá a chamada da função 'luta' da classe ginásio, se o usuário
         * sair como vencedor da luta ele ganhará uma insignia correspondente
         * aquele ginásio. Se o usuário perder duas vezes seguidas contra o
         * mesmo líder ele podera trocar os seus pokemon e tentar desafiar
         * novamente.
         * Ganha o jogo se o usuário conseguir derrotar os 8 líderes
         * de ginásio e conquistar as 8 insignias.
         */
