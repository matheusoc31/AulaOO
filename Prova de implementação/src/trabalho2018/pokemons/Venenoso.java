 ...
 * para o mesmo. Objetos dessa classe passam a ter o atributo Venenoso.
 *
 * @author Matheus de Oliveira Carvalho
 */
public class Venenoso extends Pokemon {

    public Venenoso(String nome, int HP, int ataque, int defesa, Ataque atq1, Ataque atq2) {
    ...
    public double ataque(Pokemon p, int atckAdd) {
        ...
        if (dano > 0) {
            if ((p instanceof Grama)) {
                ...
                if ((p instanceof Terrestre) || (p instanceof Psiquico)) {
                    return dano * (0.6);
                } else {
                    return dano;
                }
